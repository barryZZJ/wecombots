...
@contextmanager
def httpRequest(session, url, method, payload: [dict, str, bytes] = None, use_proxy=False, **params):
    """
    ...
    **params :
    ...
    UA = {
        ...
        'pc': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.0.0 Safari/537.36'
    }
...
def assert_json(resp: requests.Response, msg=''):
    try:
